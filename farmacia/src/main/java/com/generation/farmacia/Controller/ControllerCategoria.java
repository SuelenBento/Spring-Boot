...
public class ControllerCategoria {
	...
	public ResponseEntity<List<ModelCategoria>> GetByTitulo(@PathVariable String titulo) {
	...
	@PutMapping
	public ResponseEntity<ModelCategoria> putBody(@RequestBody ModelCategoria categoria) {
